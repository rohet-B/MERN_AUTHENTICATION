        ...
        <form onSubmit={onSubmitHandler}>
            ...
            <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
                ...
                onChange={(e)=>{setEmail(e.target.value)}} 
                 value={email} 
                className='text-slate-400 bg-transparent outline-none' type="email" placeholder='Email ID' required/>
            </div>
            <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
                ...
                value={password} 
                className='text-slate-400 bg-transparent outline-none' type="password" placeholder='Password' required/>
            </div>
